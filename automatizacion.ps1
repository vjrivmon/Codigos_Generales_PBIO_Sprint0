...
Copy-Item -Recurse "Backend/src/nodejs/*" "$TEMP_DIR/Backend/src/nodejs" -Exclude "app_web"
...
if (Get-Command docker-compose -ErrorAction SilentlyContinue) {
    ...
    & "$env:ProgramFiles\docker-compose.exe" -f "$TEMP_DIR/Backend/src/docker-compose.yml" up --build
}
