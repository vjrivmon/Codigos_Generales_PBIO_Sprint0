...
\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md741}{}\doxysection{Install}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md741}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s API to no longer display or track deprecations.\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md742}{}\doxysection{API}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md742}
...
{\bfseries{NOTE}} this library has a similar interface to the {\ttfamily debug} module, and this module uses the calling file to get the boundary for the call stacks, so you should always create a new {\ttfamily deprecate} object in each file and not within some central file.\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md743}{}\doxysubsection{depd(namespace)}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md743}
Create a new deprecate function that uses the given namespace name in the messages and will display the call site prior to the stack entering the file this function was called from. It is highly suggested you use the name of your module as the namespace.\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md744}{}\doxysubsection{deprecate(message)}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md744}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md745}{}\doxysubsection{deprecate.\+function(fn, message)}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md745}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md746}{}\doxysubsection{deprecate.\+property(obj, prop, message)}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md746}
...
\end{DoxyCode}
\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md748}{}\doxysubsection{process.\+env.\+NO\+\_\+\+DEPRECATION}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md748}
...
{\bfseries{NOTE}} This will not suppress the deperecations given to any \char`\"{}deprecation\char`\"{} event listeners, just the output to STDERR.\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md749}{}\doxysubsection{process.\+env.\+TRACE\+\_\+\+DEPRECATION}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md749}
...
{\bfseries{NOTE}} This will not trace the deperecations silenced by {\ttfamily NO\+\_\+\+DEPRECATION}.\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md750}{}\doxysection{Display}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md750}
...
\end{DoxyCode}
\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md751}{}\doxysection{Examples}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md751}
\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md752}{}\doxysubsection{Deprecating all calls to a function}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md752}
...
\end{DoxyCode}
\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md753}{}\doxysubsection{Conditionally deprecating a function call}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md753}
...
\end{DoxyCode}
\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md754}{}\doxysubsection{Deprecating property access}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md754}
...
\end{DoxyCode}
\hypertarget{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md755}{}\doxysection{License}\label{md_Backend_nodejs_node_modules_depd_Readme_autotoc_md755}
