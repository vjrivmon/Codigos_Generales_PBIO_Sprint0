...
public class Medicion {
  ...
  private String id_sensor; // Cambiar de int a String
    private double valorGas;
    private double valorTemperatura;

    // Constructor
    public Medicion(String hora, double latitud, double longitud, String id_sensor, double valorGas, double valorTemperatura) {
        this.hora = hora;
